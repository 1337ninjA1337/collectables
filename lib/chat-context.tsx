...
type ChatContextValue = {
  ...
  refreshChat: (otherUserId: string) => Promise<void>;
...
export function ChatProvider({ children }: React.PropsWithChildren) {
  ...
  const value = useMemo<ChatContextValue>(
    ...
    [ready, previews, unreadTotal, getMessages, canMessage, ensureChatWith, sendMessage, markRead, clearChat, refreshChat, refreshAll],
  );
