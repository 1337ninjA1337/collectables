...
// parseCurrencyValue / parseCurrencyValueDetailed / CURRENCY_ERROR_I18N_KEY
// moved to `lib/format-currency-input.ts` so node tests exercise the real
// parsers — import them from there, not from this component.
