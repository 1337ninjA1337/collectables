...
/**
 * The button that grows a `useChunkedList` window, for the three screens that
 * have one.
 *
 ...
 * with the same three i18n keys, the same two style rules, and the same
 ...
 * only reason this is a component rather than a fourth.
 *
